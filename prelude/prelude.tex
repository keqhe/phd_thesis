...
\title{Improving Datacenter Network Performance via the Intelligent Edge}
\author{Keqiang He}
\date{}
...
\oralexamdate{5/29/2017}
\committeeone{Srinivasa A. Akella, Professor, Computer Science}
\committeetwo{Suman Banerjee, Professor, Computer Science}
