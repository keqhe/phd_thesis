...
plot "ecmp.mice.fct.cdf"  using ($1/1000):2 title "ECMP" w lp ls 1 pointinterval 200 ,\
"mptcp.mice.fct.cdf" using ($1/1000):2 title "MPTCP" w lp ls 2 pointinterval 200, \
"presto.mice.fct.cdf"  using ($1/1000):2 title "Presto" w lp ls 3 pointinterval 200, \
"optimal.mice.fct.cdf"  using ($1/1000):2 title "Optimal" w lp ls 4 pointinterval 200
