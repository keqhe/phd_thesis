...
plot 'macro_tput_errorbar.dat' using ($2/1000):($3/1000):($4/1000):xtic(1) t "ECMP" w hist ls 1 fs pattern 1, '' using ($5/1000):($6/1000):($7/1000) t "MPTCP" w hist ls 2 fs pattern 2, '' using ($8/1000):($9/1000):($10/1000) t "Presto" w hist ls 3 fs pattern 3, '' using ($11/1000):($12/1000):($13/1000)  t "Optimal" w hist ls 4 fs pattern 4
