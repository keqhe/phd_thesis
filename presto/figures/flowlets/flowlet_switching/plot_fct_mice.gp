...
plot "flowlet_switching_100us.latency.cdf"  using ($1/1000):2 title "Flowlet switching (100us)" w lp ls 1 pointinterval 100 ,\
"flowlet_switching_500us.latency.cdf" using ($1/1000):2 title "Flowlet switching (500us)" w lp ls 2 pointinterval 100, \
"presto.latency.cdf"  using ($1/1000):2 title "Presto" w lp ls 3 pointinterval 100
