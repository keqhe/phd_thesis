...
set output "scalability_compare_loss.pdf"

set ylabel "Loss Rate (percent)" offset 1.8
...
set ytics ('0' 0.00001, '0.0001' 0.0001, '0.001' 0.001, '0.01' 0.01)

###use ejr jain metric
#plot \
#"loss.dat" using 1:2 title "ECMP" w lp ls 1 pointsize 2, \
#"loss.dat" using 1:6 title "MPTCP" w lp ls 2 pointsize 2, \
