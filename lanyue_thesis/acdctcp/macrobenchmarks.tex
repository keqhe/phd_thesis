...
buffer allocation scheme, similar to an experiment in the DCTCP paper~\cite{dctcp}.}
...
sizes are sampled from a web-search~\cite{dctcp}
and a data-mining workload~\cite{vl2,conga}, whose flow size distribution has a heavier tail.
