...
%strict latency and bandwidth requirements from workloads such as big data analytics and search~\cite{dctcp,dean2013tail}, public cloud providers must ensure their
...
The outline of this chapter is as follows. Background and motivation are discussed in \sref{background}.~\acdc{}'s design is outlined in \sref{design} and
implementation in \sref{impl}. Results are presented in \sref{results}.
