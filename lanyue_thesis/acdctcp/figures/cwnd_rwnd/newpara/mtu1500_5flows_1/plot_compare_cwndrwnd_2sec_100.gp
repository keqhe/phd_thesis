...
set terminal pdf font "Gill Sans,29" enhanced
...
set output "measure_cwnd_rwnd_gap_15k_5flows_2sec_100msec.pdf"
...
plot "tcpprobe.out_2.000014_0.1"  using 1:2 title "DCTCP" w line ls 1 linewidth 0.1, \
"syslog.out_1.998199_0.1"  using 1:2 title "Ours" w line ls 2 linewidth 0.1
