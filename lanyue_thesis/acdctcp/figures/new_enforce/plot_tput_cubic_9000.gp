...
set output "new_tput_cwnd_rwnd_cubic_9k.pdf"
...
plot "tput_cwnd_9000.dat"  using 1:($2/1000) title "CWND" w lp ls 5 linewidth 10 pointsize 2.5, \
"tput_rwnd_9000.dat"  using 1:($2/1000) title "RWND" w lp ls 2 linewidth 10 pointsize 2.5
