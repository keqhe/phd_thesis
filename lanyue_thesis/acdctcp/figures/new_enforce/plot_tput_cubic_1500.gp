...
set output "new_tput_cwnd_rwnd_cubic_15k.pdf"

set ylabel "Throughput (Gbps)" offset 2
set xlabel "Max CWND (pkts) or RWND (MSS)"
...
plot "tput_cwnd_1500.dat"  using 1:($2/1000) title "CWND" w lp ls 5 linewidth 10 pointsize 2.5, \
"tput_rwnd_1500.dat"  using 1:($2/1000) title "RWND" w lp ls 2 linewidth 10 pointsize 2.5
