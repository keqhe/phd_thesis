...
set output "sender_15k_compare_cpu_witherrbar.pdf"
...
plot 'sender_15k_compare_cpu_errorbar.dat' using ($2):($2-$3):($2+$4):xtic(1) t "Baseline" w hist ls 1 fs pattern 1, '' using ($5):($5-$6):($5+$7) t "AC/DC" w hist ls 3 fs pattern 3
