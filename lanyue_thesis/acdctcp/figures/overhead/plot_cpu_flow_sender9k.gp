...
set output "sender_9k_compare_cpu_witherrbar.pdf"
...
plot 'sender_9k_compare_cpu_errorbar.dat' using ($2):($2-$3):($2+$4):xtic(1) t "Official" w hist ls 1 fs pattern 1, '' using ($5):($5-$6):($5+$7) t "Ours" w hist ls 2 fs pattern 2
