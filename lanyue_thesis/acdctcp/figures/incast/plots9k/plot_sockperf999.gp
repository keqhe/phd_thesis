...
set output "incast_sockperf999th_vary_sender.pdf"

set ylabel "TCP RTT (milliseconds)" offset 2
...
plot "sockperf999_9000.dat"  using 1:($2/1000) title "CUBIC" w lp ls 5 linewidth 10 pointsize 2, \
"sockperf999_9000.dat" using 1:($3/1000) title "DCTCP" w lp ls 2 linewidth 10 pointsize 2,\
"sockperf999_9000.dat"  using 1:($4/1000) title "AC/DC"  w lp ls 3 linewidth 10 pointsize 2
