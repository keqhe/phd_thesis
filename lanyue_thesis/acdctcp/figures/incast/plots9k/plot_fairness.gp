...
set output "incast_fairness_vary_sender.pdf"

set ylabel "Jain's Fariness Index" offset 2
...
plot "fairness_9000.dat"  using 1:2 title "CUBIC" w lp ls 5 linewidth 15 pointsize 2.5, \
"fairness_9000.dat" using 1:3 title "DCTCP" w lp ls 2 linewidth 15 pointsize 2.5,\
"fairness_9000.dat"  using 1:4 title "AC/DC"  w lp ls 3 linewidth 15 pointsize 2.5
