...
set output "incast_47to1_test_sockperf.pdf"
...
plot "default47_cubic_sockperf.cdf"  using ($1/1000):2 title "CUBIC" w lp ls 5 linewidth 7 pointsize 1.5 pointinterval 50 ,\
"dctcp47_sockperf.cdf" using ($1/1000):2 title "DCTCP" w lp ls 2 linewidth 7 pointsize 1.5 pointinterval 50, \
"ours47_sockperf.cdf"  using ($1/1000):2 title "AC/DC"  w lp ls 3 linewidth 7 pointsize 1.5 pointinterval 50
