...
set output "shuffle_mice16KB_fct.pdf"

set ylabel "CDF" offset 2
set xlabel "Mice FCT (milliseconds)"
...
plot "default_reno/default_reno_mice16KB.fct.cdf"  using 1:2 title "CUBIC" w lp ls 5 linewidth 7 pointsize 1.5 pointinterval 500,\
"dctcp/dctcp_mice16KB.fct.cdf" using 1:2 title "DCTCP" w lp ls 2 linewidth 7 pointsize 1.5 pointinterval 500,\
"ours_with_cubic/ours_with_cubic_mice16KB.fct.cdf"  using 1:2 title "AC/DC"  w lp ls 3 linewidth 7 pointsize 1.5 pointinterval 700
