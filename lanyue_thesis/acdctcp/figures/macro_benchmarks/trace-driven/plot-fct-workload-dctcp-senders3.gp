...
set output "trace_driven_workload_dctcp_senders3.pdf"
...
plot "mice-senders3_cubic-K1-S600-Bdctcp-FS1-AS1-eth2.cdf"  using ($2*1000):1 title "Default" w lp ls 1 pointinterval 1000 ,\
"mice-senders3_dctcp-K1-S600-Bdctcp-FS1-AS1-eth2.cdf" using ($2*1000):1 title "DCTCP" w lp ls 2 pointinterval 1000, \
"mice-senders3_ours-K1-S600-Bdctcp-FS1-AS1-eth2.cdf"  using ($2*1000):1 title "Ours"  w lp ls 3 pointinterval 1000
