...
set output "default_all_cubic_tput.pdf"
...
plot "default_all_cubic_tput.out.maxmin"  using 1:($2/1000) title "Max" w lp ls 5 linewidth 10 pointsize 2, \
"" using 1:($3/1000)  title "Min" w lp ls 2 linewidth 10 pointsize 2 , \
"" using 1:($4/1000)  title "Mean" w lp ls 3 linewidth 10 pointsize 2 , \
""  using 1:($5/1000) title "Median" w lp ls 4 linewidth 10 pointsize 2
