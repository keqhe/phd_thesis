...
set output "tput_rwnd_9k_nodelay.pdf"

set ylabel "Tput (Mbps)" offset 1
set xlabel "Receiver's Window Size (bytes)"
...
plot "tput_rwnd_9k.dat"  title "MTU=9K" w lp ls 1 linewidth 5 pointsize 2, \
"tput_rwnd_9k_nodelay.dat"  title "MTU=9K (no dela ack)" w lp ls 2 linewidth 5 pointsize 2
