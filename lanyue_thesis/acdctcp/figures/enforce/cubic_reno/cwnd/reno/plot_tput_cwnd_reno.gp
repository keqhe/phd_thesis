...
set output "tput_cwnd_reno_9k_15k.pdf"
...
plot "cwnd_tput_9000_reno.dat"  title "MTU=9K" w lp ls 1 linewidth 5 pointsize 2, \
"cwnd_tput_1500_reno.dat"  title "MTU=1.5K" w lp ls 2 linewidth 5 pointsize 2
