...
set output "tput_cwnd_rwnd_cubic_9k.pdf"
...
plot "cwnd/cubic_cubic/tput_cwnd_9000.dat"  using 1:($2/1000) title "CWND" w lp ls 1 linewidth 8 pointsize 2, \
"rwnd/cubic_cubic/tput_rwnd_9000_add.dat"  using 1:($2/1000) title "RWND" w lp ls 2 linewidth 8 pointsize 2
