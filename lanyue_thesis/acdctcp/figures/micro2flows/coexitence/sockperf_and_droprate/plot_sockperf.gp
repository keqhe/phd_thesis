...
set output "coexistence_sockperf.pdf"

set ylabel "CDF" offset 2
set xlabel "CUBIC TCP Round Trip Time (milliseconds)"
...
plot "cubic_dctcp_official_CUBIC_sockperf.cdf"  using ($1/1000):2 title "CUBIC w/o AC/DC" w lp ls 1 linewidth 7 pointsize 1.5 pointinterval 50 ,\
"cubic_dctcp_ours_CUBIC_sockperf.cdf" using ($1/1000):2 title "CUBIC w/ AC/DC" w lp ls 3 linewidth 7 pointsize 1.5 pointinterval 20
