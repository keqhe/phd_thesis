...
plot "cubic_dctcp_official2_CUBIC_sockperf.cdf"  using ($1/1000):2 title "OVS" w lp ls 1 pointinterval 300 ,\
"cubic_dctcp_ours_CUBIC_sockperf.cdf" using ($1/1000):2 title "OVS-DCTCP" w lp ls 2 pointinterval 100, \
