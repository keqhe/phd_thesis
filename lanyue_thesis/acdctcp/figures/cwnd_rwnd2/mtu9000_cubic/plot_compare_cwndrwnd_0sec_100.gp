...
set output "cubic_measure_cwnd_rwnd_gap_9k_5flows_0sec_100msec.pdf"
...
plot "tcpprobe.out_0.001115_0.1"  using 1:2 title "CUBIC CWND" w line ls 1 linewidth 0.1, \
"syslog.out_0.000000_0.1"  using 1:2 title "Our RWND" w line ls 2 linewidth 0.1
