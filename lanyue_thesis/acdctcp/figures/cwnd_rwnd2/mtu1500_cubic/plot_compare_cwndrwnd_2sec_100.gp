...
set output "cubic_measure_cwnd_rwnd_gap_15k_5flows_2sec_100msec.pdf"
...
plot "tcpprobe.out_2.002698_0.1"  using 1:2 title "CUBIC" w line ls 1 linewidth 12, \
"syslog.out_2.000003_0.1"  using 1:2 title "AC/DC" w line ls 3 linewidth 10
