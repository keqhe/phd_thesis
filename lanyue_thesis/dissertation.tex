...
\defensedate{December 1 2015}
\committeeMemberOne{Andrea Arpaci-Dusseau, Professor, Computer Sciences}
\committeeMemberTwo{Remzi Arpaci-Dusseau, Professor, Computer Sciences}
\committeeMemberThree{Shan Lu, Associate Professor, Computer Sciences}
\committeeMemberFour{Michael Swift, Associate Professor, Computer Sciences}
\committeeMemberFive{Xinyu Zhang, Assistant Professor, ECE}
...
%\include{intro/intro}                  % Chapter 1
%\include{presto/presto}
%\include{acdctcp/acdctcp}
%\include{rate_limiter/rate_limiter}
