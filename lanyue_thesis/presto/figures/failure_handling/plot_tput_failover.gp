...
set output "failover_compare_tput_witherrbar.pdf"
...
plot 'failure_handling_tput_errorbar.dat' using ($2/1000):($3/1000):($4/1000):xtic(1) t "Symmetry" w hist ls 1 fs pattern 1, '' using ($5/1000):($6/1000):($7/1000) t "Failover" w hist ls 2 fs pattern 2, '' using ($8/1000):($9/1000):($10/1000)  t "Weighted" w hist ls 3 fs pattern 3
