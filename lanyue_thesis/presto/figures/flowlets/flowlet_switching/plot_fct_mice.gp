...
set output "flowlet_presto_compare_sockperf.pdf"
...
plot "flowlet_switching_100us.latency.cdf"  using ($1/1000):2 title "Flowlet switching (100us)" w lp ls 1 pointinterval 200 pointsize 1.2,\
"flowlet_switching_500us.latency.cdf" using ($1/1000):2 title "Flowlet switching (500us)" w lp ls 2 pointinterval 200 pointsize 1.2, \
"presto.latency.cdf"  using ($1/1000):2 title "Presto" w lp ls 3 pointinterval 200 pointsize 1.2
