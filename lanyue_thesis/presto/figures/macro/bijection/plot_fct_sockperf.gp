...
set output "macro_compare_fct_bijection_sockperf.pdf"
...
plot "ecmp.sockperf.fct.cdf"  title "ECMP" w lp ls 1 linewidth 4 pointsize 1 ,\
"mptcp.sockperf.fct.cdf" title "MPTCP" w lp ls 2 linewidth 4 pointsize 1, \
"presto2.sockperf.fct.cdf"  title "Presto" w lp ls 3 linewidth 4 pointsize 1, \
"optimal.sockperf.fct.cdf"  title "Optimal" w lp ls 4 linewidth 4 pointsize 1
