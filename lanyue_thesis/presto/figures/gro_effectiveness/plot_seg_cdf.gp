...
plot "dcn16_without/chunk_seg.txt.cdf" using 1:2 title "Official GRO" w lp ls 1 pointinterval 4 pointsize 3,\
"dcn16_with/chunk_seg.txt.cdf" using 1:2 title "Presto GRO" w lp ls 2 pointinterval 4 pointsize 3
