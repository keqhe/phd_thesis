...
def Plot2RateLimiters():
    latency_files = [
      ['sockperf1_baseline.log', 'skpf1_2G.log', 'skpf1_3G.log', 'skpf1_4G.log', 'skpf1_5G.log'],
      ['sockperf2_baseline.log', 'skpf2_2G.log', 'skpf2_3G.log', 'skpf2_4G.log', 'skpf2_5G.log']
    ]
    legends =   ['no iperf', '2Gbps', '3Gbps', '4Gbps', '5Gbps' ]

    tput_files = [
      [ 'iperf1_2G.txt', 'iperf1_3G.txt', 'iperf1_4G.txt', 'iperf1_5G.txt' ],
      [ 'iperf2_2G.txt', 'iperf2_3G.txt', 'iperf2_4G.txt', 'iperf2_5G.txt' ]
    ]
    xticklabels=[ '2Gbps', '3Gbps', '4Gbps', '5Gbps' ]
