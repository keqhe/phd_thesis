...
files = [ 'limiter1/iperf%dmbps%diperfs%d.log' % (rate, numIperf, i) for i in range(1, numIperf+1)] + [ 'limiter2/iperf%dmbps%diperfs%d.log' % (rate, numIperf, i) for i in range(1, numIperf+1)]
