...
def main():
    ...
    figName='1gbps.pdf'
    tputFiles = [
    '1000m/iperf-1000-20000.txt',
    '1000m/iperf-1000-40000.txt',
    '1000m/iperf-1000-60000.txt',
    '1000m/iperf-1000-80000.txt',
    '1000m/iperf-1000-100000.txt'
    ]
    rttFiles = [
    '1000m/sockperf-1000-20000.log',
    '1000m/sockperf-1000-40000.log',
    '1000m/sockperf-1000-60000.log',
    '1000m/sockperf-1000-80000.log',
    '1000m/sockperf-1000-100000.log',
    ]
    legends=['20KB', '40KB', '60KB', '80KB', '100KB']
    ylim=(0, 1200)
    ...
    figName='2gbps.pdf'
    tputFiles = [
    '2000m/iperf-2000-20000.txt',
    '2000m/iperf-2000-40000.txt',
    '2000m/iperf-2000-60000.txt',
    '2000m/iperf-2000-80000.txt',
    '2000m/iperf-2000-100000.txt'
    ]
    rttFiles = [
    '2000m/sockperf-2000-20000.log',
    '2000m/sockperf-2000-40000.log',
    '2000m/sockperf-2000-60000.log',
    '2000m/sockperf-2000-80000.log',
    '2000m/sockperf-2000-100000.log',
    ]
    legends=['20KB', '40KB', '60KB', '80KB', '100KB']
    ylim=(0, 2400)
    Plot(figName, rttFiles, tputFiles, legends, ylim)
