...
def PlotLatencyCDF():
    data_files = [
    'sockperf-1000-10000.log',
    'sockperf-1000-20000.log',
    'sockperf-1000-40000.log',
    'sockperf-1000-60000.log',
    'sockperf-1000-80000.log',
    'sockperf-1000-100000.log'
    ]
    legends = [
    '10KB',
    '20KB',
...
def PlotTput():
    data_files = [
    'iperf-1000-10000.txt',
    'iperf-1000-20000.txt',
    'iperf-1000-40000.txt',
    'iperf-1000-60000.txt',
    'iperf-1000-80000.txt',
    'iperf-1000-100000.txt'
    ]
    legends = [
    '10K',
    '20K',
