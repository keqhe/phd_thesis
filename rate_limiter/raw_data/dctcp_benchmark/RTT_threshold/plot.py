...
#====================param================================
FIGSIZE = (8, 4)
FIGNAME='dctcp_threshold_1000mbps.pdf'
TPUT_YLIM = (0, 1000)
LATE_YLIM = (0, 500)
...
def Plot():
    ...
    plt.legend(patterns, [l.get_label() for l in patterns], ncol=1, loc='upper right', framealpha=1)
