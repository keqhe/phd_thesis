...
def main():
    ...
    '1gbps/60KB_tput.txt',
    '1gbps/80KB_tput.txt',
    '1gbps/100KB_tput.txt'
    ]
    rttFiles = [
    '1gbps/20KB_sockperf.log',
    '1gbps/40KB_sockperf.log',
    '1gbps/60KB_sockperf.log',
    '1gbps/80KB_sockperf.log',
    '1gbps/100KB_sockperf.log'
    ]
    ...
    '2gbps/60KB_tput.txt',
    '2gbps/80KB_tput.txt',
    '2gbps/100KB_tput.txt'
    ]
    rttFiles = [
    '2gbps/20KB_sockperf.log',
    '2gbps/40KB_sockperf.log',
    '2gbps/60KB_sockperf.log',
    '2gbps/80KB_sockperf.log',
    '2gbps/100KB_sockperf.log'
    ]
    legends=['20KB', '40KB', '60KB', '80KB', '100KB']
    ylim=(0, 2400)
    Plot(figName, rttFiles, tputFiles, legends, ylim)
