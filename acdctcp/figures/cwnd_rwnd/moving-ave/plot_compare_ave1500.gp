...
set output "measure_cwnd_rwnd_gap_15k_5flows_ave100.pdf"
...
plot "dctcp-1.5k-100ms"  using 1:2 title "DCTCP" w line ls 2 linewidth 10, \
"ours-1.5k-100ms"  using 1:2 title "AC/DC" w line ls 3 linewidth 10
