...
set output "measure_cwnd_rwnd_gap_9k_5flows_2sec_100msec.pdf"
...
plot "tcpprobe.out_0.200002_0.1"  using 1:2 title "DCTCP" w line ls 1 linewidth 0.1, \
"syslog.out_0.202123_0.1"  using 1:2 title "Ours" w line ls 2 linewidth 0.1
