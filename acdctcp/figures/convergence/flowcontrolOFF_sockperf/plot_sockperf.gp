...
set output "convergence_test_sockperf.pdf"
...
plot "tcp-flowctlOFF-tuningON_sockperf.cdf"  using ($1/1000):2 title "CUBIC (Default)" w lp ls 5 linewidth 7 pointsize 1.5 pointinterval 100 ,\
"dctcp-official_sockperf.cdf" using ($1/1000):2 title "DCTCP" w lp ls 2 linewidth 7 pointsize 1.5 pointinterval 100, \
"ovsdctcp_sockperf.cdf"  using ($1/1000):2 title "AC/DC"  w lp ls 3 linewidth 7 pointsize 1.5 pointinterval 100
