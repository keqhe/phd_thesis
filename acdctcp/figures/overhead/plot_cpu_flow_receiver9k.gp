...
set output "receiver_9k_compare_cpu_witherrbar.pdf"
...
plot 'receiver_9k_compare_cpu_errorbar.dat' using ($2):($2-$3):($2+$4):xtic(1) t "official" w hist ls 1 fs pattern 1, '' using ($5):($5-$6):($5+$7) t "ours" w hist ls 2 fs pattern 2
