...
set output "stride4_mice16KB_fct.pdf"
...
plot "default_cubic_mice16KB.fct.cdf"  using 1:2 title "CUBIC" w lp ls 5 linewidth 7 pointsize 1.5 pointinterval 200,\
"dctcp_mice16KB.fct.cdf" using 1:2 title "DCTCP" w lp ls 2 linewidth 7 pointsize 1.5 pointinterval 200,\
"ours-with-cubic_mice16KB.fct.cdf"  using 1:2 title "AC/DC"  w lp ls 3 linewidth 7 pointsize 1.5 pointinterval 200
