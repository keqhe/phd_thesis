...
set output "shuffle_big512MB_fct.pdf"
...
plot "default_reno/default_reno_512MB.fct.cdf"  using ($1/1000):2 title "CUBIC" w lp ls 5 linewidth 7 pointsize 1.5 pointinterval 1000,\
"dctcp/dctcp_512MB.fct.cdf" using ($1/1000):2 title "DCTCP" w lp ls 2 linewidth 7 pointsize 1.5 pointinterval 1000,\
"ours_with_cubic/ours_with_cubic_512MB.fct.cdf"  using ($1/1000):2 title "AC/DC"  w lp ls 3 linewidth 7 pointsize 1.5 pointinterval 1000
