...
set output "cubic_measure_cwnd_rwnd_gap_15k_5flows_0sec_100msec.pdf"
...
plot "tcpprobe.out_0.001706_0.1"  using 1:2 title "CUBIC" w line ls 1 linewidth 12, \
"syslog.out_0.000000_0.1"  using 1:2 title "AC/DC" w line ls 3 linewidth 10
