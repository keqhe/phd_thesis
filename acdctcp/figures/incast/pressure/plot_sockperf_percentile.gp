...
set output "incast_pressure_compare_sockperf.pdf"
...
plot 'sockperf_percentile.dat' using 2 t "CUBIC" w hist ls 1 fs pattern 1,'' using 3 t "DCTCP" w hist ls 2 fs pattern 2, '' using 4:xtic(1)  t "AC/DC" w hist ls 3 fs pattern 3
