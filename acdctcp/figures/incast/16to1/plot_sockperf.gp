...
set output "incast_16to1_test_sockperf.pdf"
...
plot "default16_cubic_sockperf.cdf"  using ($1/1000):2 title "Default" w lp ls 1 pointinterval 300 ,\
"dctcp16_dbcheck2_sockperf.cdf" using ($1/1000):2 title "DCTCP" w lp ls 2 pointinterval 100, \
"ours16_reno_dbcheck2_sockperf.cdf"  using ($1/1000):2 title "Ours"  w lp ls 3 pointinterval 100
