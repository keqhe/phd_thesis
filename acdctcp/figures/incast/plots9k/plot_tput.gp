...
set output "incast_tput_vary_sender.pdf"

set ylabel "Average Tput (Mbps)" offset 2
...
plot "tput_9000.dat"  using 1:2 title "CUBIC" w lp ls 5 linewidth 15 pointsize 2.5, \
"tput_9000.dat" using 1:3 title "DCTCP" w lp ls 2 linewidth 15 pointsize 2.5,\
"tput_9000.dat"  using 1:4 title "AC/DC"  w lp ls 3 linewidth 15 pointsize 2.5 
