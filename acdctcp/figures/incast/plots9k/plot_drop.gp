...
set output "incast_droprate_vary_sender.pdf"
...
plot "droprate_9000.dat"  using 1:2 title "CUBIC" w lp ls 5 linewidth 10 pointsize 2, \
"droprate_9000.dat" using 1:3 title "DCTCP" w lp ls 2 linewidth 10 pointsize 2,\
"droprate_9000.dat"  using 1:4 title "AC/DC"  w lp ls 3 linewidth 10 pointsize 2 
