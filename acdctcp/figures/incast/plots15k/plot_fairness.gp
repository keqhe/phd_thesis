...
set output "15k_incast_fairness_vary_sender.pdf"
...
plot "fairness_1500.dat"  using 1:2 title "Default" w lp ls 1, \
"fairness_1500.dat" using 1:3 title "DCTCP" w lp ls 2 ,\
"fairness_1500.dat"  using 1:4 title "Ours"  w lp ls 3 
