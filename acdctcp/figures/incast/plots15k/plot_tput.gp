...
set output "15k_incast_tput_vary_sender.pdf"
...
plot "tput_1500.dat"  using 1:2 title "Default" w lp ls 1, \
"tput_1500.dat" using 1:3 title "DCTCP" w lp ls 2 ,\
"tput_1500.dat"  using 1:4 title "Ours"  w lp ls 3 
