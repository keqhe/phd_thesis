...
set output "15k_incast_sockperf999th_vary_sender.pdf"

set ylabel "50th percentile TCP RTT (μs)" offset 2
...
plot "sockperf999_1500.dat"  using 1:2 title "Default" w lp ls 1, \
"sockperf999_1500.dat" using 1:3 title "DCTCP" w lp ls 2 ,\
"sockperf999_1500.dat"  using 1:4 title "Ours"  w lp ls 3 
