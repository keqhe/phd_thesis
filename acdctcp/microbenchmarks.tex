...
\begin{figure}[!t]
        \centering
  \includegraphics[width=0.45\textwidth]{acdctcp/figures/convergence/flowcontrolOFF_sockperf/convergence_test_sockperf.pdf}
...
\begin{figure}[t]
        \centering
  \includegraphics[width=0.45\textwidth]{acdctcp/figures/overhead/sender_15k_compare_cpu_witherrbar.pdf}
...
\begin{figure}[t]
        \centering
  \includegraphics[width=0.45\textwidth]{acdctcp/figures/overhead/receiver_15k_compare_cpu_witherrbar.pdf}
...
\begin{figure}[t]
        \centering
  \includegraphics[width=0.45\textwidth]{acdctcp/figures/qos/qos_stacked.pdf}
...
\begin{figure}[!t]
        \centering
  \includegraphics[width=0.45\textwidth]{acdctcp/figures/micro2flows/coexitence/sockperf_and_droprate/coexistence_sockperf.pdf}
